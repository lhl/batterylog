...
- [ ] Create a package layout for the new `batterylog` CLI
- [ ] Keep root `batterylog.py` as a legacy compatibility shim for upgraded `/opt` installs
...
- [ ] Implement DB path resolution with clear precedence
